...
export const designProjectList: IProject[] = [
  ...
  },
  {
    ...
    galleries: [
      ...
      {
        title: 'Graphic & Print Design Design',
        id: 'ejmGraphic',
        images: [
          new CustomImageItem({
